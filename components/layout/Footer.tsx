...
export function Footer() {
  ...
  return (
    <footer className="mt-20 border-t border-surface-border bg-surface-secondary/50 backdrop-blur-sm md:mt-24 lg:mt-32">
      <div className="container-custom py-12 lg:py-16">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          {/* Brand Section */}
          <div className="lg:col-span-2">
            <Link href="/" className="inline-block">
              <h3 className="mb-4 font-heading text-2xl font-bold text-gradient">
                {personalInfo.name}
              </h3>
            </Link>
            ...
            <div className="flex gap-4">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  className="group flex h-10 w-10 items-center justify-center rounded-lg bg-surface-tertiary text-text-secondary transition-all hover:bg-primary/10 hover:text-primary"
          ...
          {/* Contact Info */}
          <div>
            <h4 className="mb-4 font-semibold text-text-primary">Get in Touch</h4>
            <ul className="space-y-2 text-sm text-text-secondary">
              ...
              <li className="pt-2">
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 rounded-md bg-primary/10 px-3 py-1.5 text-primary transition-colors hover:bg-primary/20"
                >
